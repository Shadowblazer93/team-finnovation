-- ============================================
-- COMPLETE DATABASE SETUP (Safe to re-run)
-- Run this in Supabase SQL Editor
-- ============================================

-- Drop existing policies for assets (to avoid conflicts)
...
-- Drop existing policies (now safe since tables exist)
...
-- Grant permissions for behavioral tables
